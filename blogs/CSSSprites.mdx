...
desc: >-
  本次小程序项目中，主包的大小已经大到无法发布了。这时候最先想到的就是把主包里的Static目录的静态图片全部清理掉换成远程图片。但是全部替换的会导致页面加载时会并发很多请求，虽然响应都很快，但是一次请求太多图片资源也是很影响体验的，因此想到了引入精灵图的概念来进行整改。
image: csssprites.png
tags:
  - 小程序
  - CSS
time: '2021-09-13'
